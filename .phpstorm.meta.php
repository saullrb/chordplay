...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/saull/Projects/chordplay/public/storage' => 'string',
...
'filesystems.links./home/saull/Projects/chordplay/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'debugbar.queries.explain','sanctum.csrf-cookie','home','search',
'search.show','dashboard','profile.edit','profile.update','profile.destroy',
...
'artists.create','artists.store','artists.songs.create','artists.favorite','artists.unfavorite',
'artists.songs.store','artists.songs.edit','artists.songs.update','songs.favorite','songs.unfavorite',
'artists.show','artists.index','artists.songs.show','storage.local',);
...
'APP_NAME','APP_ENV','APP_KEY','APP_URL','APP_TIMEZONE',
'DB_CONNECTION','DB_DATABASE','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','DB_CONNECTION',
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','MAIL_MAILER','MAIL_HOST',
